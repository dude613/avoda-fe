...
import { AddTeamMemberAPI, ArchiveTeamMember, EditTeamMemberAPI, fetchOrganization, unarchiveTeamMember, deleteTeamMember, fetchArchivedTeamMembers } from "@/service/api"
...
export default function TeamMembers() {
  ...
  const handleApplyFilters = () => {
    ...
    // For now, we'll just use the table's built-in filtering
  }
  ...
  const archivedColumns: ColumnDef<TeamMember>[] = useMemo(
    () => [
      {
        accessorKey: "name",
        header: ({ column }) => (
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex flex-col sm:flex-row items-center justify-between">
              ...
              <div className="flex items-center gap-2 mt-2 sm:mt-0  w-full  sm:w-2/5">
                <FilterPanel
